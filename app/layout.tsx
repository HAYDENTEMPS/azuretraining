...
export const metadata: Metadata = {
  title: 'Azure Quiz App',
  description: 'Interactive Azure certification quiz with integrated study guide - AZ-104, AZ-204, AZ-500',
  keywords: ['Azure', 'AZ-104', 'AZ-204', 'AZ-500', 'Microsoft', 'Certification', 'Quiz', 'Study'],
            ...
            <footer className="bg-gray-50 border-t border-gray-200 mt-auto dark:bg-gray-800 dark:border-gray-700">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                  <p>Azure Certification Quiz - AZ-104, AZ-204, AZ-500</p>
                  <p className="mt-1">
